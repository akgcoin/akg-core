...
* akgcoin.conf: contains configuration settings for akgcoind or akgcoin-qt
* akgcoind.pid: stores the process id of akgcoind while running
...
* debug.log: contains debug information and general logging generated by akgcoind or akgcoin-qt
