...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s akgcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  akgcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded akgcoin transaction") + "\n" +
              "  akgcoin-tx [options] -create [commands]   " + _("Create hex-encoded akgcoin transaction") + "\n" +
              "\n";
