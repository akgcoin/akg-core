...
const char * const BITCOIN_CONF_FILENAME = "akgcoin.conf";
const char * const BITCOIN_PID_FILENAME = "akgcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "AKGcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/AKGcoin";
#else
    // Unix
    return pathRet / ".akgcoin";
#endif
#endif
}
